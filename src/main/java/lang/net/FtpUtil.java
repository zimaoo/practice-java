...
public class FtpUtil {
    ...
    public static void main(String[] args) {
        String srcFile="frt/backup/AGT/AGT_COURT/zip/";
        String dstFileName = "/Users/wanba/frt1/backup/AGT/AGT_COURT/S378H101411081001.zip";
        //srcFileName = "/frt/backup/AGT/AGT_COURT/zip/".concat(bankId)+".zip";
        String srcFileName = "/frt0/backup/AGT/AGT_COURT/zip/S378H101411081001.zip";
        //TrcLog.log("GetFile.log", "开始取文件---srcFileName="+srcFileName);
        //调用工具远程取文件
        FtpUtil ftpUtil = new FtpUtil("localhost",21,"frt","frt");
        try {
            //下载压缩包
            if(ftpUtil.open()) {

                //下载
                boolean b = ftpUtil.get(srcFileName, dstFileName);
                System.out.println(b);

                //备份压缩包到远程服务器备份目录
                boolean be = ftpUtil.upload(dstFileName, "S378H101411081001.zip", "/frt/backup/AGT/AGT_COURT/hist");
